namespace Framework.Data.NHibernate
{
    ...
    /// that make up the Configuration object be Serializable.  This includes any custom Data.NHibernate 
    /// user types implementing <see cref="Data.NHibernate.UserTypes.IUserType"/>.</remarks>
    public class NHibernateConfigurationFileCache : INHibernateConfigurationCache
    {
        ...
        /// <param name="configPath">Data.NHibernate configuration xml file.  This is used to determine if the 
