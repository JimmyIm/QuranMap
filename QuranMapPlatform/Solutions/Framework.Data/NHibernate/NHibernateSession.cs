namespace Framework.Data.NHibernate
{
    ...
    // using global::Data.NHibernate.Validator.Engine;

    using Framework.Data.NHibernate.NHibernateValidator;
    ...
    public static class NHibernateSession
    {
        ...
        /// <summary>
        ///     Maintains a dictionary of Data.NHibernate session factories, one per database.  The key is 
        ...
        /// <summary>
        ///     Used to get the current Data.NHibernate session if you're communicating with a single database.
        ...
        /// <summary>
        ///     Used to get the current Data.NHibernate session associated with a factory key; i.e., the key 
        ///     associated with an Data.NHibernate session factory for a specific database.
        /// 
            ...
            IPersistenceConfigurer persistenceConfigurer)
        {
            ...
            {
                // If this Data.NHibernate config throws an exception, null the Storage reference so 
