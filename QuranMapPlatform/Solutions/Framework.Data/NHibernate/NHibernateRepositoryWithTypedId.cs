namespace Framework.Data.NHibernate
{
    ...
    ///     * Spring configuration; e.g., <object id = "CustomerDao" type = "Framework.Data.NHibernateSupport.GenericDao&lt;CustomerAlias, string>, Framework.Data" autowire = "byName" />
    /// </summary>
    public class NHibernateRepositoryWithTypedId<T, TId> : INHibernateRepositoryWithTypedId<T, TId>
    {
        ...
        /// <summary>
        ///     Translates a domain layer lock mode into an Data.NHibernate lock mode via reflection.  This is 
        ///     provided to facilitate developing the domain layer without a direct dependency on the 
        ///     Data.NHibernate assembly.
        /// </summary>
